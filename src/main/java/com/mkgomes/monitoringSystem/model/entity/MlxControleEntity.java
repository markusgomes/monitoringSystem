...
@Entity
@Table(name = "mlx90614controle")
public class MlxControleEntity {
    ...
    public MlxControleEntity() {}

    public MlxControleEntity(SessaoEntity sessao, CicloEntity ciclo, Long millisRelativo, Float tempAmb, Float tempIR,
